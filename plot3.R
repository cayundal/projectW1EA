...
legend(x = c(1170440502.87,1170485649.6), y = c(39.52,28),legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),lwd=c(2.5,2.5,2.5),,col=c("black","red","blue"),cex=0.5,y.intersp=0.75,xjust = 1)
